...
// you use interfaces for common functionality
// since now you can pass any object or model:
// buildFilter(req.Exec, &models.Exec{})
// buildFilter(req.Student, &models.Student{})
// buildFilter(req.Teacher, &models.Teacher{})
